...
public class Heart_Rate_ChartFragmrnt_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Heart_Rate_ChartFragmrnt_Adapter(Context context,List<Chart> charts,NewGraphicModel newGraphicModel){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == 0){
            ...
            viewHolder = new Heart_Rate_ChartFragmrnt_Adapter.LineViewHolder(view);
        }else if(viewType == 1){
            View view = LayoutInflater.from(context).inflate(R.layout.barchart_recy_item,parent,false);
            viewHolder = new Heart_Rate_ChartFragmrnt_Adapter.BarViewHolder(view);
        }
        return viewHolder;
    }
    ...
    public void setHeartChart(LineViewHolder holder, int position){
        ...
        if(graphicType == 3){
            ...
            if(newGraphicModel.getGraphicDayList().size()>0) {
                average1 = Float.parseFloat(newGraphicModel.getGraphicDayList().get(0).getVal());
            }else {
                average1 = 0;
            }
        }
