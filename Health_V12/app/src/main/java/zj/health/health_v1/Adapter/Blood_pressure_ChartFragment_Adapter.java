...
public class Blood_pressure_ChartFragment_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Blood_pressure_ChartFragment_Adapter(Context context,List<Chart> charts,NewGraphicModel newGraphicModel){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == 0){
            ...
            viewHolder = new Blood_pressure_ChartFragment_Adapter.LineViewHolder(view);
        }else if(viewType == 1){
            View view = LayoutInflater.from(context).inflate(R.layout.barchart_recy_item,parent,false);
            viewHolder = new Blood_pressure_ChartFragment_Adapter.BarViewHolder(view);
        }
        return viewHolder;
    }
    ...
    public void setBlood_pressure(LineViewHolder holder, int position){
        ...
        ((LineViewHolder) holder).title_text.setText(newGraphicModel.getTitle());
        float average1 = 0;
        float average2 = 0;
        ...
        if(graphicType == 3){
            if(newGraphicModel.getYear().size()>0) {
                average1 = Float.parseFloat(newGraphicModel.getYear().get(0).getSysAverage());
                average2 = Float.parseFloat(newGraphicModel.getYear().get(0).getDiaAverage());
            }else{
                average1 = 0;
                average2 = 0;
            }
            ...
            if(newGraphicModel.getMonthly().size()>0) {
                average1 = Float.parseFloat(newGraphicModel.getMonthly().get(0).getSysAverage());
                average2 = Float.parseFloat(newGraphicModel.getMonthly().get(0).getDiaAverage());
            }else{
                average1 = 0;
                average2 = 0;
            }
            ...
            if(newGraphicModel.getGraphicDayList().size()>0) {
                ...
                average1 = sysTotal/newGraphicModel.getGraphicDayList().size();
                average2 = diaTotal/newGraphicModel.getGraphicDayList().size();
            }else {
                average1 = 0;
                average2 = 0;
            }
