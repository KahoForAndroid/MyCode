...
import zj.health.health_v1.IM.ui.AddFriendActivity;
import zj.health.health_v1.IM.ui.ProfileActivity;
...
public class FriendProfile implements ProfileSummary {
    ...
    public String getGroupName(){
        ...
        if (profile.getFriendGroups().size() == 0){
            return Health_AppLocation.instance.getString(R.string.default_group_name);
        }else{
