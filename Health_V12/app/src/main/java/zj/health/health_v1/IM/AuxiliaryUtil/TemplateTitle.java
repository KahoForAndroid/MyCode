...
//                    if(consult){
////                        Intent it = new Intent(((Activity) getContext()), Doctor_service_Activity.class);
...
//                    }
    ...
    public void setConsult(boolean consult1){
        consult = consult1;
    }
    ...
    //隐藏详细按钮
    public void gone_btn_more(){
        LinearLayout btn_more = (LinearLayout)findViewById(R.id.btn_more);
