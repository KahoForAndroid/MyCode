...
public class Weight_ChartFragment extends Fragment implements View.OnClickListener {


    private View view = null;
    private RecyclerView recyclerView;
    private Weight_ChartFragment_Adapter adapter;
                ...
                try {
                    ...
                    if(jsonObject.optString("msg").equals("success")) {
                        ...
                        if(newGraphicModel!=null){
                            newGraphicModel.setLable(getString(R.string.Kg));
                            newGraphicModel.setTitle(getString(R.string.weight));
    ...
    private Handler WeightList_pressureHandler = new Handler(){
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if(msg.what == 200){
    ...
    private Handler Update_WeightList_pressureHandler = new Handler(){
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if(msg.what == 200){
                ...
                try {
                    ...
                    if(jsonObject.optString("msg").equals("success")) {
                        ...
                        getWeight_for_day(startCalendar.getTimeInMillis());
                        ...
                        getWeight_for_List(calendar_list_start.getTimeInMillis(),calendar_list_end.getTimeInMillis());
                    }
                } catch (JSONException e) {
                    LoadingDialog.getLoadingDialog().StopLoadingDialog();
                    e.printStackTrace();
...
//        BarChart = (com.github.mikephil.charting.charts.BarChart)view.findViewById(R.id.barChart);
    ...
    private void setData() {
        ...
        adapter = new Weight_ChartFragment_Adapter(getActivity(), charts, newGraphicModel);
        list_adapter = new Body_ChartList_Adapter(getActivity(),bodyChartListModelList,2);
        ...
        switch(graphicType){
            case 1:
                ...
                if(newGraphicModel.getGraphicDayList().size()>0) {
                    ...
                    for (int i = 1;i<25;i++){
                        entriesys_Average.add(new Entry(i, Float.valueOf(9.9f)));
                    }
        ...
        public void onTimeSelect(Date date, View v) {
            switch (graphicType){
                ...
                case 2:
                    ...
                    getWeight(startCalendar.getTimeInMillis(),endCalendar.getTimeInMillis());
                    break;
                case 3:
                    graphicType = 3;
                    week_button.setBackgroundResource(R.drawable.radius_gary);
    ...
    private void getWeight(long startDate,long endDate){
        String data = "st"+"="+startDate+"&"+"et"+"="+endDate;
        new PostUtils().Get(Constant.weight+data,true,WeightHandler,getActivity());
    }

    private void getWeight_for_day(long Today){
        String data = "st"+"="+Today;
        new PostUtils().Get(Constant.weight_day+data,true,WeightHandler,getActivity());
    }
     ...
     * @param endTime 结束时间
     */
    private void getWeight_for_List(long StartTime,long endTime){
        String data = "st"+"="+StartTime+"&et="+endTime+"&page=0&perPage=20";
        new PostUtils().Get(Constant.weight_list+data,true,WeightList_pressureHandler,getActivity());
    }
     ...
     */
    private void Update_weight_pressure_list(String json){
        LoadingDialog.getLoadingDialog().StartLoadingDialog(getActivity());
        new PostUtils().JsonPost(Constant.update_or_delete_weight_list,json,Update_WeightList_pressureHandler, (BaseActivity) getActivity());
    }
     ...
     * @param id 数据ID
     */
    private void Delete_weight_list(String id){
        LoadingDialog.getLoadingDialog().StartLoadingDialog(getActivity());
        String json = "id="+id;
        new PostUtils().Delete(Constant.update_or_delete_weight_list+json,true,Update_WeightList_pressureHandler, (BaseActivity) getActivity());
    }
    ...
    public void Edit_chart_Dailog(Context context, final View view, final int position){
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(type_text.getText().toString().length()>0){
                    ...
                    bodyChartListModel.setWeight(type_text.getText().toString());
                    Update_weight_pressure_list(gson.toJson(bodyChartListModel));
                }else{
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Delete_weight_list(bodyChartListModelList.get(position).getId());
            }
        });
