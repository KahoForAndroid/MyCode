...
import zj.health.health_v1.Adapter.Blood_Sugar_ChartFragment_Adapter;
...
public class Blood_Sugar_ChartFragment extends Fragment implements View.OnClickListener{

    private View view = null;
    private RecyclerView recyclerView;
    private Blood_Sugar_ChartFragment_Adapter adapter;
    private List<Chart> charts;
    private GraphicModel.graphics graphics = null;
    ...
    private Handler blood_SugarHandler = new Handler(){
        @Override
                ...
                try {
                    ...
                    if(jsonObject.optString("msg").equals("success")) {
                        ...
                        if(newGraphicModel!=null){
                            newGraphicModel.setLable(getString(R.string.Mmol_L));
                            newGraphicModel.setTitle(getString(R.string.blood_sugar));
    ...
    private Handler SugarList_pressureHandler = new Handler(){
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if(msg.what == 200){
    ...
    private Handler Update_SugarList_pressureHandler = new Handler(){
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if(msg.what == 200){
                ...
                try {
                    ...
                    if(jsonObject.optString("msg").equals("success")) {
                        ...
                        getblood_Sugar_for_day(startCalendar.getTimeInMillis());
                        ...
                        getSugar_for_List(calendar_list_start.getTimeInMillis(),calendar_list_end.getTimeInMillis());
                    }
                } catch (JSONException e) {
                    LoadingDialog.getLoadingDialog().StopLoadingDialog();
                    e.printStackTrace();
...
//        BarChart = (com.github.mikephil.charting.charts.BarChart)view.findViewById(R.id.barChart);
    ...
    private void setData(){
        ...
        adapter = new Blood_Sugar_ChartFragment_Adapter(getActivity(),charts,newGraphicModel);
        list_adapter = new Body_ChartList_Adapter(getActivity(),bodyChartListModelList,5);
        ...
        switch(graphicType){
            case 1:
                ...
                if(newGraphicModel.getGraphicDayList().size()>0) {
                    ...
                    for (int i = 1;i<25;i++){
                        entriesys_Average.add(new Entry(i, Float.valueOf(0.9f)));
                    }
        ...
        public void onTimeSelect(Date date, View v) {
            switch (graphicType){
                ...
                case 2:
                    ...
                    getblood_Sugar(startCalendar.getTimeInMillis(),endCalendar.getTimeInMillis());
                    break;
                case 3:
                    graphicType = 3;
                    week_button.setBackgroundResource(R.drawable.radius_gary);
    ...
    private void getblood_Sugar(long startDate,long endDate){
        String data = "st"+"="+startDate+"&"+"et"+"="+endDate;
        new PostUtils().Get(Constant.blood_Sugar+data,true,blood_SugarHandler,getActivity());
    }

    private void getblood_Sugar_for_day(long Today){
        String data = "st"+"="+Today;
        new PostUtils().Get(Constant.blood_Sugar_day+data,true,blood_SugarHandler,getActivity());
    }
     ...
     * @param endTime 结束时间
     */
    private void getSugar_for_List(long StartTime,long endTime){
        String data = "st"+"="+StartTime+"&et="+endTime+"&page=0&perPage=20";
        new PostUtils().Get(Constant.Sugar_list+data,true,SugarList_pressureHandler,getActivity());
    }
     ...
     */
    private void Update_Sugar_pressure_list(String json){
        LoadingDialog.getLoadingDialog().StartLoadingDialog(getActivity());
        new PostUtils().JsonPost(Constant.update_or_delete_Sugar_list,json,Update_SugarList_pressureHandler, (BaseActivity) getActivity());
    }
     ...
     * @param id 数据ID
     */
    private void Delete_Sugar_list(String id){
        LoadingDialog.getLoadingDialog().StartLoadingDialog(getActivity());
        String json = "id="+id;
        new PostUtils().Delete(Constant.update_or_delete_temp_list+json,true,Update_SugarList_pressureHandler, (BaseActivity) getActivity());
    }
    ...
    public void Edit_chart_Dailog(Context context, final View view, final int position){
        ...
        body_type.setText(getString(R.string.blood_sugar));
        type_text.setText(bodyChartListModelList.get(position).getBloodGlucose());
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(type_text.getText().toString().length()>0){
                    ...
                    bodyChartListModel.setBloodGlucose(type_text.getText().toString());
                    Update_Sugar_pressure_list(gson.toJson(bodyChartListModel));
                }else{
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Delete_Sugar_list(bodyChartListModelList.get(position).getId());
            }
        });
