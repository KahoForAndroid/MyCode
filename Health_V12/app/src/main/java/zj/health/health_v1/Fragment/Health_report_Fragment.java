...
public class Health_report_Fragment extends Fragment{
...
//                            uploadList();
    ...
    public void uploadList(){
        if(getArguments()!=null && getArguments().getString("friendid")!=null){
            String config = "friendId="+getArguments().getString("friendid")+"&type=1";
...
//        String json = "type"+"="+"1";
//        new PostUtils().Get(Constant.report_list+json,true,mineHandler, (BaseActivity) getActivity());
    }
