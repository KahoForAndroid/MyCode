...
public class Body_weight_Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view == null){
            view = inflater.inflate(R.layout.body_weight_fragment,container,false);
        }
        initView();
        BindListener();
        setData();
    ...
    private void initView(){
        ...
        weight_edit = (EditText)view.findViewById(R.id.weight_edit);
    ...
    private void Submit(JSONObject jsonObject){
        ...
        new PostUtils().JsonPost(Constant.post_weight,jsonObject,submitHandler, (BaseActivity) getActivity());
    }
