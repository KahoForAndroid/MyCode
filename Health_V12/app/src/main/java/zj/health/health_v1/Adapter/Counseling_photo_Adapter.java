...
public class Counseling_photo_Adapter extends RecyclerView.Adapter<Counseling_photo_Adapter.ViewHolder>{
    private Context context;
    private List<LocalMedia> list;
    private Picture_OnItemClick onItemClick;

    public Counseling_photo_Adapter(Context context,List<LocalMedia> list){
