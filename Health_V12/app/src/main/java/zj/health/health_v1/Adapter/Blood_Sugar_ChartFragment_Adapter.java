...
public class Blood_Sugar_ChartFragment_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Blood_Sugar_ChartFragment_Adapter(Context context,List<Chart> charts,NewGraphicModel newGraphicModel){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == 0){
            ...
            viewHolder = new Blood_Sugar_ChartFragment_Adapter.LineViewHolder(view);
        }else if(viewType == 1){
            View view = LayoutInflater.from(context).inflate(R.layout.barchart_recy_item,parent,false);
            viewHolder = new Blood_Sugar_ChartFragment_Adapter.BarViewHolder(view);
        }
        return viewHolder;
    }
    ...
    public void setBlood_sugarChart(LineViewHolder holder, int position){
        ...
        holder.title_text.setText(StringUtil.trimNull(newGraphicModel.getTitle()));
        float average1 = 0;
