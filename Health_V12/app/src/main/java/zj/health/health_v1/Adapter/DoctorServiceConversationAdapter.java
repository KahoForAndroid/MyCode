...
public class DoctorServiceConversationAdapter extends ArrayAdapter<Conversation> {
     ...
     */
    public DoctorServiceConversationAdapter(Context context, int resource, List<Conversation> objects) {
...
//            .priority(Priority.HIGH) //优先级
    ...
    public void NeedToUpdate(boolean update){
        if(update){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(data.getFriendIcon() == null || data.getFriendIcon().contains(Constant.photo_IP)){
            Glide.with(context).
                    load(data.getFriendIcon()).
