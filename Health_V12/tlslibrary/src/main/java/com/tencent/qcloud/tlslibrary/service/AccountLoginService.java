...
public class AccountLoginService {
    ...
    public AccountLoginService(Context context,Context mainsContext,
                               String txt_username,
                               String txt_password) {
        this.context = context;
        this.MainsContext = mainsContext;
        tlsService = TLSService.getInstance();
        pwdLoginListener = new PwdLoginListener();
...
//        String thirdappPackageNameSucc = MainsContext.getPackageName();
//        String thirdappClassNameSucc = MainsContext.getClass().getName();
