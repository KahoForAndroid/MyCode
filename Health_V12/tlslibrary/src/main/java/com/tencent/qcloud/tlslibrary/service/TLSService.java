...
//        accountHelper.setTestHost("113.108.64.238", false);    // 不走sso
    ...
    public void initHealthAccountLoginService(Context context,Context mainsContext,
                                         String txt_username,
                                         String txt_password) {
        accountLoginService = new AccountLoginService(context,mainsContext, txt_username, txt_password);
    }
